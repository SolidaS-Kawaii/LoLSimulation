...
class GameController:
    ...
    def _ai_ban(self, side: str) -> Dict:
        ...
        2. Randomly select from top 5 recommendations (for variety)
        ...
        try:
            ...
            # Random from top 5 for variety! 🎲
            top_5 = recommendations[:5]
            if top_5:
                # Shuffle to increase variety
                available_to_ban = [rec for rec in top_5
                                   if self.engine.state.is_champion_available(rec.champion_id)]

                if available_to_ban:
                    rec = random.choice(available_to_ban)
                    ...
                    if success:
                        ...
                        return {
                            ...
                            'side': side,
                            'reason': f"Strategic ban (random from top 5)"
                        }
